...
'[In Quest of a Pangram](https://www.leesallows.com/files/In%20Quest%20of%20a%20Pangram1.pdf)'.
...
search space in around 2.88 seconds on my Apple M1 using SIMD and threading.

Credit to [@nkanaev](https://github.com/nkanaev) for adding threading in
[this PR](https://github.com/tuzz/pangram-machine/pull/1). Previously, it took
13.5 seconds in single-threaded mode.
